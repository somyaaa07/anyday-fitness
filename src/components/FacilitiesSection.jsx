import { amenities, equipmentPartners } from "../data/amenties";
    ...
    <section className="relative py-20 sm:py-28 bg-surface2/80 overflow-hidden">
      <div className="container-x">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12 sm:mb-16">
          ...
          <div className="flex items-center gap-3 shrink-0 rounded-lg border border-primary/40 bg-primary/10 px-5 py-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-5">
          {amenities.map((a) => (
            <div
              key={a.title}
              className="group relative flex flex-col items-center text-center gap-3 rounded-xl border border-white/10 bg-surface p-5 sm:p-6 hover:border-primary/50 hover:-translate-y-1 transition-all duration-300"
            >
